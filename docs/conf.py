...
project = u'Django – Mały Bar'
copyright = u'2017, Robert Bednarz'
...
htmlhelp_basename = u'Django – Mały Bar'
...
latex_documents = [
  ('index', 'DjangoMalyBar.tex', u'Dokumentacja Django Mały Bar',
...
man_pages = [
    ('index', 'djangomalybar', u'Dokumentacja Django Mały Bar',
     [u'Robert Bednarz'], 1)
]
...
texinfo_documents = [
  ('index', 'DjangoMalyBar', u'Dokumentacja Django Mały Bar',
   u'Robert Bednarz', 'DjangoMalyBar', 'Aplikacja sieciowa w Django.',
   'Miscellaneous'),
]
